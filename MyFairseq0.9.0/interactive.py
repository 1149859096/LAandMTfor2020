...
from fairseq_cli.interactive1 import load_model, fairseq_translate
...
def result(sentence, src_lan, tar_lan):
    ...
    # 德法之间的零资源翻译
        ...
        result = fairseq_translate(tokenizer, bpe, args, task, models, use_cuda, generator, tgt_dict, src_dict, raw_txt)
